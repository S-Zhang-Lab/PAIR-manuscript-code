...
python 02_Cellbc_Whitelist_Mapping.py \
    ...
    --extracted_data ${DATA_DIR}/PAIR_output/PAIR_matched_extracted_data_table_mismatch01_AdjR2_2000000.txt \
    --output ${DATA_DIR}/PAIR_output/PAIR_matched_extracted_data_table_CellBC.mapped_2000000.txt \
    --unmapped ${DATA_DIR}/PAIR_output/PAIR_matched_extracted_data_table_CellBC.unmapped_2000000.txt \
    --tolerance 2 \
    --k 10 \
    --log_file ${DATA_DIR}/PAIR_output/PAIR_matched_extracted_data_table_CellBC.mapping.log_2000000.txt
