...
#$ -N PAIR_2000000       # Specify job name
...
# full run
python 01_Extract_PAIR.py   --input_r1 ${DATA_DIR}/PAIR_TT_C12-SI_TT_C12_2333FLLT3_S3_L007_R1_001_2000000.fastq.gz \
                            --input_r2 ${DATA_DIR}/PAIR_TT_C12-SI_TT_C12_2333FLLT3_S3_L007_R2_001_2000000.fastq.gz \
                            --output_r1 ${OUT_DIR}/PAIR_matched_R1_mismatch01_AdjR2_2000000.fastq.gz \
                            --output_r2 ${OUT_DIR}/PAIR_matched_R2_mismatch01_AdjR2_2000000.fastq.gz \
                            --output_table ${OUT_DIR}/PAIR_matched_extracted_data_table_mismatch01_AdjR2_2000000.txt \
