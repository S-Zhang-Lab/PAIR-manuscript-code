...
# Specify file paths
barcodes_file <- "./data/PAIR_output_Rd2/PAIR_f1/PAIR_matched_sparse_UMI_matrix_rows.txt"
features_file <- "./data/PAIR_output_Rd2/PAIR_f1/PAIR_matched_sparse_UMI_matrix_columns.txt"
matrix_file   <- "./data/PAIR_output_Rd2/PAIR_f1/PAIR_matched_sparse_UMI_matrix.mtx"
